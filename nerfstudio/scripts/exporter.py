...
class ExportSphericalHarmonicsCloud(Exporter):
    ...
    """Threshold based on STD of the average distances across the sh cloud to remove outliers."""
    ...
    def main(self) -> None:
        ...
        _, pipeline, _, _ = eval_setup(self.load_config) # Do we have to load all the data????
